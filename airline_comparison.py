...
#####################################################################################
    ## USER INPUTS ##
    with st.container(border=True):
        st.write("Select an airline and a year to see the top 10 insights and annual summary. Content is generated by ChatGPT based on the SEC filings associated with the selections.")
        ...
        with llm_col2:
            # Select year(s)
            llm_year = st.pills("Select Year", years, default=max(years), selection_mode="single")
#####################################################################################
    ## OUTPUT/DISPLAY ##
