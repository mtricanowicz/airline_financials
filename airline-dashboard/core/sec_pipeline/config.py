...
class PeriodSpec:
    ...
    def date_window(self) -> tuple[datetime, datetime]:
        ...
        Q4 and FY use a three-month extension because the annual 10-K commonly
        arrives after February and is the primary filing for Q4 results.
        """
    ...
    def period_end(self) -> datetime:
        """Return the actual reporting-period end, excluding the filing grace period."""
